...
<body>
  <div class="store-container">
    ...
    <h1 style="font-size:5rem; color:#0170BB; margin-bottom:1rem;">ERROR 503</h1>
</div>
      <svg role="img" xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
          <title xml:lang="en">Mantenimiento</title>
        <defs>
            <filter id="f1">
          ...
          <g id="ball">
            ...
            <g id="plane">
              ...
              <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB"> ESTAMOS TRABAJANDO... </text>
          ...
          <g id="door">
            ...
            <g id="sign">
              ...
              <text transform="matrix(1.0027 0 0 1 789.6294 721.7501)" fill="#FFF" font-family='Fredoka One' font-size="38"> ClOSE </text>
