    ...
    <div class="row g-4 justify-content-center">
        ...
        @php
            $cards = [
                ...
                /*-OSLP-*/ ['icon' => 'bi-person-lines-fill icon-vendedor', 'titulo' => 'Vendedores',              'texto' => 'Sincroniza los vendedores.',                         'servicio' => 'Vendedores',              'metodo1' => 'SBO_Agrega_Todo_Vendedores_OSLP',                   ],
            ];
        @endphp
